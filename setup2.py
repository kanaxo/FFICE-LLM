...
# Example: Performing a search in the Chroma vector store
query = "Is ATFM restriction part of the R/T element?"
...
print("Building template and QA Chain...\n")
# Build prompt
